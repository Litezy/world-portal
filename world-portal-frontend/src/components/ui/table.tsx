  ...
  return (
    <tr
      ...
      className={cn(
        ...
        "data-[interactive=true]:cursor-pointer data-[interactive=true]:hover:bg-muted/40",
...
export function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-11 px-4 text-left align-middle text-[11px] font-medium tracking-[0.12em] whitespace-nowrap text-muted-foreground uppercase",
