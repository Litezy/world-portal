...
- [x] **1.1 Architecture & ADR Documentation**
  - [x] Draft Technical Architecture Decision Record ([`0008-agency-portal-backend-architecture.md`](./adr/0008-agency-portal-backend-architecture.md))
  - [x] Draft ADR for Dummies ([`0008-agency-portal-backend-architecture.dummies.md`](./adr/0008-agency-portal-backend-architecture.dummies.md))
